...
- [x] **G6: Add validation tests**: TestG6VerifyShieldModifiersSumCorrectly validates shield modifier summation (total damage: 0.0191, total pass-through: 1.3500). TestG6ValidateTuningConstants validates all tuning constants (AFK: 1m59.5s, Range: 20000, Speed: 0.50). TestG6ShieldModifierConsistency validates consistency across 8 ship classes
